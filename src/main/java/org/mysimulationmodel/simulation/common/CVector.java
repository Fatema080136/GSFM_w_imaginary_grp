...
public final class CVector
{
    ...
    {
        //Math.toDegrees( Math.acos( p_v1.dot( p_v2 ) / ( p_v1.length() * p_v2.length() ) ) ) ;
        return Math.acos( p_v1.dot( p_v2 ) / ( p_v1.length() * p_v2.length() ) ) ;
     ...
     * code taken from https://github.com/bit101/CodingMath/blob/master/episode33/main_interactive.js
